  ...
  export default {
    computed: {
      ...
      quarter: function() {
        var obj = {}
        if(this.allStocks.length > 0) {
          var tmp = this.allStocks[0].Finance.FinanceStatDaily
          obj['year'] = tmp.Year;
          obj['date'] = tmp.Date;
